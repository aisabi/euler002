...
def fiboEvenSum(n):
  # You can do it!
  # 1/ Get the Fibonacci numbers for n elements
  # to count the number from 3 because variable nombres begin with 2 numbers
  compteur = 3 
  nombres = [1,2]
  liste_fibonacci = nombres[:] # copy of the list called 'nombres'
  ...
  print('List of Fibonacci numbers you asked for the',n,
        'first numbers : ',liste_fibonacci)

  # 2/ Find the sum of the even-valued terms
  liste_even = []
  for nombre in liste_fibonacci:
    if nombre%2 == 0:
      liste_even.append(nombre)
  print('List of even numbers from Fibonacci list you asked : ',liste_even)
  somme = sum(liste_even)
  return somme

print('TOTAL :',fiboEvenSum(10))
